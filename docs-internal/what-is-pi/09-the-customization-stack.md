...
**Placement:**
- `~/.sdd/agent/extensions/` (global)
- `.sdd/extensions/` (project-local)
...
**Placement:**
- `~/.sdd/agent/skills/` or `~/.agents/skills/` (global)
- `.sdd/skills/` or `.agents/skills/` (project, searched up to git root)
...
**Placement:**
- `~/.sdd/agent/prompts/` (global)
- `.sdd/prompts/` (project-local)
...
**Placement:**
- `~/.sdd/agent/themes/` (global)
- `.sdd/themes/` (project-local)
