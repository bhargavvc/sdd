...
/**
 * Build script for the SDD native Rust addon.
 *
 * Usage:
...
console.log(`Building sdd-engine (${profile})...`);
...
const libraryNames = {
  darwin: "libsdd_engine.dylib",
  linux: "libsdd_engine.so",
  win32: "sdd_engine.dll",
};
