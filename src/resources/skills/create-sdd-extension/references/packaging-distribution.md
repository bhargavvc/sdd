<overview>
Packaging extensions for distribution via npm, git, or local paths. Creating SDD/pi packages.
</overview>
...
<installing>
```bash
sdd install npm:@foo/bar@1.0.0
sdd install git:github.com/user/repo@v1
