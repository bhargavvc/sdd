...
export async function buildPlanSlicePrompt(
  ...
  const commitInstruction = "Do not commit — .sdd/ planning docs are managed externally and not tracked in git.";
...
export async function buildReassessRoadmapPrompt(
  ...
  const reassessCommitInstruction = "Do not commit — .sdd/ planning docs are managed externally and not tracked in git.";
