...
6. Seed `.sdd/DECISIONS.md` — use the **Decisions** output template below. Append rows for any architectural or pattern decisions made during discussion.
7. {{commitInstruction}}
...
4. Seed `.sdd/DECISIONS.md` — use the **Decisions** output template below.
