  ...
  if (isAutoActive()) {
    pi.sendMessage({
      ...
      content: [
        ...
        `**Override:** ${change}`,
        "",
        "This override has been saved to `.sdd/OVERRIDES.md` and will be injected into all future task prompts.",
    ...
    pi.sendMessage({
      ...
      content: [
        ...
        `**Override:** ${change}`,
        "",
        "This override has been saved to `.sdd/OVERRIDES.md`.",
        "Before continuing, read `.sdd/OVERRIDES.md` and update the current plan documents to reflect this change.",
