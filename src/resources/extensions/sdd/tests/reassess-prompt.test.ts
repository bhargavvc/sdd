...
test('reassess-roadmap prompt loads and substitutes', () => {
    ...
    assert.ok(result.includes(".sdd/milestones/M099/slices/S03/S03-ASSESSMENT.md"), "prompt contains assessmentPath");
    assert.ok(result.includes(".sdd/milestones/M099/M099-ROADMAP.md"), "prompt contains roadmapPath");
