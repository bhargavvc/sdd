...
// loadPrompt reads from ~/.sdd/agent/extensions/sdd/prompts/ (main checkout).
...
async function main(): Promise<void> {
  ...
  console.log("\n=== reassess-roadmap prompt loads and substitutes ===");
  {
    const testVars = {
      ...
      assessmentPath: ".sdd/milestones/M099/slices/S03/S03-ASSESSMENT.md",
      roadmapPath: ".sdd/milestones/M099/M099-ROADMAP.md",
    ...
    assertTrue(result.includes(".sdd/milestones/M099/slices/S03/S03-ASSESSMENT.md"), "prompt contains assessmentPath");
    assertTrue(result.includes(".sdd/milestones/M099/M099-ROADMAP.md"), "prompt contains roadmapPath");
  ...
  console.log("\n=== reassess-roadmap contains coverage-check instruction ===");
  {
    const prompt = loadPromptFromWorktree("reassess-roadmap", {
      ...
      assessmentPath: ".sdd/milestones/M001/slices/S01/S01-ASSESSMENT.md",
