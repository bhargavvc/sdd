...
const BASE_VARS = {
  ...
  slicePath: ".sdd/milestones/M001/slices/S01",
  roadmapPath: ".sdd/milestones/M001/M001-ROADMAP.md",
  researchPath: ".sdd/milestones/M001/slices/S01/S01-RESEARCH.md",
  outputPath: "/tmp/test-project/.sdd/milestones/M001/slices/S01/S01-PLAN.md",
  inlinedContext: "--- test inlined context ---",
  dependencySummaries: "", executorContextConstraints: "",
  sourceFilePaths: "- **Requirements**: `.sdd/REQUIREMENTS.md`",
...
test("plan-slice prompt: commit instruction says do not commit (external state)", () => {
  const result = loadPrompt("plan-slice", { ...BASE_VARS, commitInstruction: "Do not commit planning artifacts — .sdd/ is managed externally." });
...
test("skillActivation default leaves no unresolved placeholder", () => {
  const result = loadPromptWithDefaultSkillActivation("execute-task", {
    ...
    taskPlanPath: ".sdd/milestones/M001/slices/S01/tasks/T01-PLAN.md",
    taskPlanInline: "Task plan",
    slicePlanExcerpt: "Slice excerpt",
    carryForwardSection: "Carry forward",
    resumeSection: "Resume",
    priorTaskLines: "- (no prior tasks)",
    taskSummaryPath: "/tmp/test-project/.sdd/milestones/M001/slices/S01/tasks/T01-SUMMARY.md",
...
test("research-slice prompt substitutes skillActivation", () => {
  const result = loadPrompt("research-slice", {
    ...
    roadmapPath: ".sdd/milestones/M001/M001-ROADMAP.md",
    contextPath: ".sdd/milestones/M001/M001-CONTEXT.md",
    milestoneResearchPath: ".sdd/milestones/M001/M001-RESEARCH.md",
    outputPath: "/tmp/test-project/.sdd/milestones/M001/slices/S01/S01-RESEARCH.md",
    inlinedContext: "Context",
    dependencySummaries: "",
    skillDiscoveryMode: "manual",
    skillDiscoveryInstructions: " Discover skills manually.",
...
test("plan-milestone prompt substitutes skillActivation", () => {
  const result = loadPrompt("plan-milestone", {
    ...
    milestonePath: ".sdd/milestones/M001",
    contextPath: ".sdd/milestones/M001/M001-CONTEXT.md",
    researchPath: ".sdd/milestones/M001/M001-RESEARCH.md",
    researchOutputPath: "/tmp/test-project/.sdd/milestones/M001/M001-RESEARCH.md",
    outputPath: "/tmp/test-project/.sdd/milestones/M001/M001-ROADMAP.md",
    secretsOutputPath: "/tmp/test-project/.sdd/milestones/M001/M001-SECRETS.md",
    inlinedContext: "Context",
...
test("guided plan milestone prompt substitutes skillActivation", () => {
  const result = loadPrompt("guided-plan-milestone", {
    milestoneId: "M001",
    milestoneTitle: "Test Milestone",
    secretsOutputPath: ".sdd/milestones/M001/M001-SECRETS.md",
