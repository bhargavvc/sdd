// sdd-tools — Structured LLM tool tests
//
// Tests the three registered tools: sdd_decision_save, sdd_requirement_update, sdd_summary_save.
...
function makeTmpDir(): string {
  const dir = fs.mkdtempSync(path.join(os.tmpdir(), 'sdd-tools-'));
...
// ═══════════════════════════════════════════════════════════════════════════
// sdd_requirement_update tool tests
// ═══════════════════════════════════════════════════════════════════════════

console.log('\n── sdd_requirement_update ──');
...

{
  ...
  try {
    ...
    const filePath = path.join(tmpDir, '.sdd', 'milestones', 'M001', 'slices', 'S01', 'S01-SUMMARY.md');
    ...
    const mFilePath = path.join(tmpDir, '.sdd', 'milestones', 'M001', 'M001-CONTEXT.md');
    ...
    const tFilePath = path.join(tmpDir, '.sdd', 'milestones', 'M001', 'slices', 'S01', 'tasks', 'T01-SUMMARY.md');
