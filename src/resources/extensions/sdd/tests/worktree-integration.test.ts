...
async function main(): Promise<void> {
  ...
  assertEq(getSliceBranchName("M001", "S01", "alpha"), "sdd/alpha/M001/S01", "explicit worktree param");
  assertEq(getSliceBranchName("M001", "S01"), "sdd/M001/S01", "no worktree param = plain branch");
  ...
  assertEq(getCurrentBranch(wt.path), "sdd/alpha/M001/S01", "worktree-namespaced slice branch");
  ...
  assertTrue(!branches.includes("sdd/alpha/M001/S01"), "slice branch cleaned up");
  ...
  assertEq(getCurrentBranch(wt.path), "sdd/alpha/M001/S02", "on S02 namespaced branch");
  ...
  assertEq(getCurrentBranch(wt2.path), "sdd/beta/M001/S01", "beta has its own namespaced branch");
  ...
  assertEq(getCurrentBranch(wt.path), "sdd/alpha/M001/S01", "alpha re-created S01");

  // Both exist simultaneously
  const allBranches = run("git branch", base);
  assertTrue(allBranches.includes("sdd/alpha/M001/S01"), "alpha S01 branch exists");
  assertTrue(allBranches.includes("sdd/beta/M001/S01"), "beta S01 branch exists");
