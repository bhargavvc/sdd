...
const tmpBase = mkdtempSync(join(tmpdir(), "sdd-draft-promotion-test-"));
...
const draftPath = join(sdd, "milestones", "M001", "M001-CONTEXT-DRAFT.md");
...
const contextPath = join(sdd, "milestones", "M001", "M001-CONTEXT.md");
