...
// ═══════════════════════════════════════════════════════════════════════════
// SDDPreferences Interface
// ═══════════════════════════════════════════════════════════════════════════

test("preferences: SDDPreferences includes token_profile field", () => {
  assert.ok(
    preferencesSrc.includes("token_profile?: TokenProfile"),
    "SDDPreferences should have token_profile field",
  );
});

test("preferences: SDDPreferences includes phases field", () => {
  assert.ok(
    preferencesSrc.includes("phases?: PhaseSkipPreferences"),
    "SDDPreferences should have phases field",
  );
});
