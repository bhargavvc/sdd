...
//
// Each of the 4 DB tools must register under its canonical sdd_concept_action name
// AND under the old sdd_action_concept name as a backward-compatible alias.
