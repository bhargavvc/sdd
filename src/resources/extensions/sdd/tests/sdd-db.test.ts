...
console.log('\n=== sdd-db: fresh DB schema init (memory) ===');
{
...
console.log('\n=== sdd-db: double-init idempotency ===');
{
...
console.log('\n=== sdd-db: active_decisions view excludes superseded ===');
{
  openDatabase(':memory:');
...
console.log('\n=== sdd-db: active_requirements view excludes superseded ===');
{
  openDatabase(':memory:');
...
console.log('\n=== sdd-db: WAL mode on file-backed DB ===');
{
  const dbPath = tempDbPath();
  openDatabase(dbPath);
...
console.log('\n=== sdd-db: transaction rollback on error ===');
{
  openDatabase(':memory:');
...
console.log('\n=== sdd-db: query wrappers return null/empty when DB unavailable ===');
{
  // Ensure DB is closed
  closeDatabase();
