...
test("detectProjectState: directory with .sdd/milestones/M001 returns v2-sdd", () => {
...
test("detectProjectState: directory with empty .sdd/milestones returns v2-sdd-empty", () => {
...
test("detectProjectState: detects preferences in .sdd/", () => {
