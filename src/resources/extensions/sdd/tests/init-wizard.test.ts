...
test("init-wizard: existing .sdd/ with milestones skips init", () => {
...
test("init-wizard: empty .sdd/ (no milestones) returns v2-sdd-empty", () => {
...
test("init-wizard: v2 .sdd/ preferences detected", () => {
...
test("init-wizard: v1 with both .planning/ and .sdd/ prioritizes v2", () => {
