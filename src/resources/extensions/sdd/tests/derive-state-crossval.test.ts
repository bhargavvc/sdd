...
// Proves both paths produce field-identical SDDState across 7 fixture scenarios,
...
/**
 * Compare every SDDState field between DB and filesystem derivation.
 * prefix identifies the scenario in assertion messages.
 */
function assertStatesEqual(dbState: SDDState, fileState: SDDState, prefix: string): void {
  // Phase
