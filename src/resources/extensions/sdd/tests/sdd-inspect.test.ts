// sdd-inspect — Tests for /sdd inspect output formatting
//
...
console.log("# === sdd-inspect: full output formatting ===");
{
  ...
  assertMatch(output, /=== SDD Database Inspect ===/, "contains header");
...
console.log("# === sdd-inspect: empty data ===");
{
  const data: InspectData = {
    schemaVersion: 1,
...
console.log("# === sdd-inspect: null schema version ===");
{
  const data: InspectData = {
    schemaVersion: null,
    counts: { decisions: 0, requirements: 0, artifacts: 0 },
...
console.log("# === sdd-inspect: five recent entries ===");
{
  const data: InspectData = {
    schemaVersion: 2,
...
console.log("# === sdd-inspect: output format ===");
{
  const data: InspectData = {
    schemaVersion: 2,
