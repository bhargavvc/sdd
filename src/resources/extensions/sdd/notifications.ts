// SDD Extension — Desktop Notification Helper
...
export function shouldSendDesktopNotification(
  ...
  preferences: NotificationPreferences | undefined = loadEffectiveSDDPreferences()?.preferences.notifications,
): boolean {
...
export function buildDesktopNotificationCommand(
  ...
  if (platform === "darwin") {
    ...
    // See: https://github.com/sdd-build/sdd-2/issues/2632
