...
export const MODE_DEFAULTS: Record<WorkflowMode, Partial<SDDPreferences>> = {
  solo: {
    git: {
      auto_push: true,
      push_branches: false,
...
/** All recognized top-level keys in SDDPreferences. Used to detect typos / stale config. */
...
export interface LoadedSDDPreferences {
  path: string;
