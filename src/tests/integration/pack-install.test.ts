...
test("tarball installs and sdd binary resolves", async (t) => {
...
test("sdd exits early with a clear message when synced resources are newer than the binary", async (t) => {
