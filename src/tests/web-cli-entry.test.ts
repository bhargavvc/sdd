...
test("resolveSddCliEntry prefers the built loader for packaged standalone interactive sessions", (t) => {
...
test("resolveSddCliEntry prefers the source loader for source-dev interactive sessions", (t) => {
  const packageRoot = makeFixture([
    "dist/loader.js",
    "src/loader.ts",
    "src/resources/extensions/sdd/tests/resolve-ts.mjs",
...
test("resolveSddCliEntry appends rpc arguments for bridge sessions", (t) => {
