 ...
 * check in src/resources/extensions/sdd/tests/git-locale.test.ts.
 *
...
const ALLOW_SHELL_INTERPOLATION: Array<[string, string]> = [
  // NPM_PACKAGE is a compile-time constant ('sdd-pi'), not user input.
  ...
  ["resources/extensions/sdd/commands-handlers.ts", "npm view ${NPM_PACKAGE}"],
  ["resources/extensions/sdd/commands-handlers.ts", "npm install -g ${NPM_PACKAGE}"],
];
