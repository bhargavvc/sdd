 ...
 * with `--experimental-transform-types`.  When SDD is installed globally via
 ...
 *
 * @param packageRoot  Absolute path to the SDD package root.
...
/**
 * Builds the Node.js subprocess prefix args for running a SDD extension module.
 *
