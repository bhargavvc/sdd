...
**File**: `src/resources/extensions/sdd/native-git-bridge.ts`
...
- `src/resources/extensions/sdd/auto.ts` (Fixes 1, 3, 5, 6)
- `src/resources/extensions/sdd/native-git-bridge.ts` (Fix 2)
- `src/resources/extensions/subagent/isolation.ts` (Fix 4)
- `src/resources/extensions/sdd/auto-dashboard.ts` (Fix 7)
- `src/resources/extensions/sdd/tests/` (new test files)
