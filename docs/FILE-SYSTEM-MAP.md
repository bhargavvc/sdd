...
| **Auto Engine** | SDD autonomous execution loop, dispatch, supervision |
...
| **Commands** | SDD slash/sub-command routing and handlers |
...
| **SDD Workflow** | Core SDD planning/execution workflow engine |
...
|------|-----------------|-------------|
| src/app-paths.ts | Config | App directory paths (SDD_HOME, sessions, web PID, prefs) |
...
| src/headless.ts | Headless Mode | Orchestrator for /sdd subcommands without TUI via RPC |
...
| src/models-resolver.ts | Config, Auth/OAuth | Resolves models.json with fallback from Pi to SDD |
| src/onboarding.ts | Onboarding | First-run wizard — LLM auth, OAuth, API keys, tool setup |
| src/pi-migration.ts | Config, Auth/OAuth | Migrates provider credentials from Pi auth.json to SDD |
...
| src/update-cmd.ts | CLI | Executes npm install to update sdd-pi package |
...
| src/web/cleanup-service.ts | Web Mode | Collects SDD branches and snapshot refs for cleanup |
| src/web/cli-entry.ts | Web Mode, CLI | Builds/resolves SDD CLI entry points for RPC/interactive |
...
### SDD Extension (Core Workflow Engine)

| File | System Label(s) | Description |
|------|-----------------|-------------|
| sdd/index.ts | SDD Workflow | Main SDD extension bootstrap and registration |
| sdd/auto.ts | Auto Engine | Automatic workflow execution and loop management |
| sdd/auto-dashboard.ts | Auto Engine, Web Mode | Real-time dashboard for auto-run progress |
| sdd/auto-worktree.ts | Auto Engine, Worktree | Automatic worktree creation and branch management |
| sdd/auto-recovery.ts | Auto Engine | Recovery for crashed/stalled workflows |
| sdd/auto-start.ts | Auto Engine | Initialization sequence for automatic execution |
| sdd/auto-worktree-sync.ts | Auto Engine, Worktree | State sync between worktrees and main |
| sdd/auto-model-selection.ts | Auto Engine, Model System | Intelligent LLM model routing |
| sdd/auto-direct-dispatch.ts | Auto Engine | Direct command dispatching without planning |
| sdd/auto-dispatch.ts | Auto Engine | Task queueing and priority-based dispatch |
| sdd/auto-timeout-recovery.ts | Auto Engine | Timeout handling and recovery |
| sdd/auto-post-unit.ts | Auto Engine | Post-unit milestone completion processing |
| sdd/auto-unit-closeout.ts | Auto Engine | Unit finalization and archiving |
| sdd/auto-verification.ts | Auto Engine | Post-execution verification |
| sdd/auto-timers.ts | Auto Engine | Timeout and deadline management |
| sdd/auto-loop.ts | Auto Engine, State Machine | Execution loop state and cycle management |
| sdd/auto-supervisor.ts | Auto Engine | Supervision and oversight of autonomous runs |
| sdd/auto-budget.ts | Auto Engine | Token/cost budgeting and tracking |
| sdd/auto-observability.ts | Auto Engine | Observability hooks and telemetry |
| sdd/auto-tool-tracking.ts | Auto Engine | Tool usage instrumentation |
| sdd/doctor.ts | Doctor/Diagnostics | Health check and system diagnostics |
| sdd/doctor-checks.ts | Doctor/Diagnostics | Individual diagnostic checks |
| sdd/doctor-providers.ts | Doctor/Diagnostics | Diagnostic data source providers |
| sdd/doctor-format.ts | Doctor/Diagnostics | Diagnostic output formatting |
| sdd/state.ts | State Machine | Milestone and workflow state management |
| sdd/history.ts | State Machine | State history and versioning |
| sdd/json-persistence.ts | State Machine | JSON-based persistence layer |
| sdd/memory-store.ts | State Machine | In-memory state storage |
| sdd/reactive-graph.ts | State Machine | Reactive dependency graph for state |
| sdd/routing-history.ts | State Machine | History of routing decisions |
| sdd/cache.ts | State Machine | Caching layer for performance |
| sdd/model-router.ts | Model System | LLM model selection and routing logic |
| sdd/worktree.ts | Worktree | Worktree creation and management |
| sdd/worktree-manager.ts | Worktree | Higher-level worktree orchestration |
| sdd/worktree-resolver.ts | Worktree | Worktree path and reference resolution |
| sdd/unit-runtime.ts | Auto Engine | Unit-level execution runtime |
| sdd/activity-log.ts | SDD Workflow | Activity tracking and logging |
| sdd/debug-logger.ts | SDD Workflow | Debug output and verbose logging |
| sdd/commands.ts | Commands | Main command dispatcher |
| sdd/commands-handlers.ts | Commands | Command-specific handlers |
| sdd/commands-bootstrap.ts | Commands | Bootstrap and initialization commands |
| sdd/commands-config.ts | Commands, Config | Configuration management commands |
| sdd/commands-extensions.ts | Commands, Extensions | Extension discovery and management |
| sdd/commands-inspect.ts | Commands, Doctor/Diagnostics | Database and state inspection tools |
| sdd/commands-logs.ts | Commands | Log viewing and filtering |
| sdd/commands-workflow-templates.ts | Commands, SDD Workflow | Workflow template management |
| sdd/commands-cmux.ts | Commands, CMux | Tmux/cmux integration commands |
| sdd/exit-command.ts | Commands | Exit and cleanup commands |
| sdd/undo.ts | Commands | Undo and rollback functionality |
| sdd/kill.ts | Commands | Process termination and cleanup |
| sdd/worktree-command.ts | Commands, Worktree | Worktree subcommands |
| sdd/namespaced-resolver.ts | SDD Workflow | Namespace and scoped resource resolution |
| sdd/error-utils.ts | SDD Workflow | Error handling and formatting |
| sdd/errors.ts | SDD Workflow | Error type definitions |
| sdd/diff-context.ts | SDD Workflow | Diff-based context extraction |
| sdd/memory-extractor.ts | SDD Workflow | Memory and context extraction from state |
| sdd/structured-data-formatter.ts | SDD Workflow | Structured output formatting |
| sdd/export-html.ts | SDD Workflow | HTML export of milestone reports |
| sdd/reports.ts | SDD Workflow | Report generation and summaries |
| sdd/notifications.ts | SDD Workflow | User notification and messaging |
| sdd/triage-ui.ts | SDD Workflow | Triage interface for issue categorization |
| sdd/guided-flow.ts | SDD Workflow | User-guided workflow orchestration |
| sdd/env-utils.ts | SDD Workflow | Environment variable utilities |
| sdd/git-constants.ts | SDD Workflow | Git-related constants and paths |
| sdd/milestone-id-utils.ts | SDD Workflow | Milestone ID generation and parsing |
| sdd/resource-version.ts | SDD Workflow | Resource versioning helpers |
| sdd/atomic-write.ts | SDD Workflow | Atomic file write operations |
| sdd/captures.ts | SDD Workflow | Artifact capture and storage |
| sdd/changelog.ts | SDD Workflow | Changelog generation |
| sdd/claude-import.ts | SDD Workflow | Claude API/resource importing |
| sdd/collision-diagnostics.ts | Doctor/Diagnostics | Collision detection and diagnostics |
| sdd/prompt-loader.ts | SDD Workflow | Prompt template loading |
| sdd/file-watcher.ts | SDD Workflow | File system change monitoring |
| sdd/parallel-eligibility.ts | SDD Workflow | Parallel execution eligibility checks |
| sdd/plugin-importer.ts | SDD Workflow, Extensions | Custom plugin/extension importing |
| sdd/verification-gate.ts | SDD Workflow | Pre-execution verification checks |
| sdd/preference-models.ts | Config, Model System | Model preference configuration |
| sdd/preferences-skills.ts | Config, Skills | Skill preference configuration |
| sdd/post-unit-hooks.ts | SDD Workflow | Post-unit execution hooks |
| sdd/skill-telemetry.ts | Skills | Skill usage and performance telemetry |
| sdd/bootstrap/* | SDD Workflow, Loader/Bootstrap | Extension initialization and hook registration |
| sdd/auto/* | Auto Engine | Auto-execution engine components |
| sdd/commands/* | Commands | Command routing and handling |
| sdd/templates/* | SDD Workflow | Output templates and formatters |
| sdd/prompts/* | SDD Workflow | System prompts and instructions |
| sdd/workflow-templates/* | SDD Workflow | Workflow starter templates and registry |
| sdd/skills/* | Skills | Integrated skill configurations |
| sdd/migrate/* | Migration | Data migration and upgrade tools |
...
| shared/format-utils.ts | SDD Workflow | String formatting utilities |
| shared/sanitize.ts | SDD Workflow | Input sanitization |
...
| create-sdd-extension/ | Skills, Extensions | SDD extension scaffolding (22 files) |
...
| web/components/sdd/roadmap.tsx | Web UI, SDD Workflow | Milestone roadmap visualization |
...
| web/app/api/knowledge/route.ts | API Routes, SDD Workflow | Knowledge base |
| web/app/api/hooks/route.ts | API Routes, SDD Workflow | Git hooks management |
...
| web/app/api/captures/route.ts | API Routes, SDD Workflow | Knowledge captures |
...
| web/lib/sdd-workspace-store.tsx | State Machine | Global workspace state store with external store |
...
| web/lib/workflow-actions.ts | SDD Workflow | Primary workflow action derivation logic |
| web/lib/workflow-action-execution.ts | SDD Workflow | Workflow action execution handler |
...
| web/lib/knowledge-captures-types.ts | SDD Workflow | Knowledge entry and captures types |
...
| vscode-extension/src/sdd-client.ts | VS Code Extension, MCP Server/Client | RPC client for SDD agent communication |
| vscode-extension/src/chat-participant.ts | VS Code Extension | Chat participant for @sdd command |
...
| native/crates/engine/src/sdd_parser.rs | SDD Workflow, Native/Rust Tools | .sdd/ directory file parser (markdown, frontmatter) |
...
| scripts/install-hooks.sh | Build System, SDD Workflow | Git hook installer |
...
| scripts/recover-sdd-1364.sh | Build System, Migration | Recovery script for issue #1364 |
| scripts/recover-sdd-1364.ps1 | Build System, Migration | Recovery script for issue #1364 (PowerShell) |
| scripts/recover-sdd-1668.sh | Build System, Migration | Recovery script for issue #1668 |
| scripts/recover-sdd-1668.ps1 | Build System, Migration | Recovery script for issue #1668 (PowerShell) |
...
| **Auto Engine** | src/resources/extensions/sdd/auto*.ts, sdd/auto-loop.ts, sdd/auto-supervisor.ts, sdd/unit-runtime.ts |
...
| **Commands** | sdd/commands*.ts, sdd/exit-command.ts, sdd/undo.ts, sdd/kill.ts, pi-coding-agent/src/core/slash-commands.ts |
...
| **Doctor / Diagnostics** | sdd/doctor*.ts, sdd/collision-diagnostics.ts, core/diagnostics.ts, web/lib/diagnostics-types.ts, web/app/api/doctor/*, forensics/* |
| **Event System** | pi-coding-agent/src/core/event-bus.ts, sdd/auto-observability.ts |
...
| **SDD Workflow** | src/resources/extensions/sdd/* (non-auto), sdd/reports.ts, sdd/notifications.ts, sdd/prompts/*, sdd/workflow-templates/* |
...
| **Loader / Bootstrap** | src/loader.ts, src/resource-loader.ts, src/tool-bootstrap.ts, src/bundled-resource-path.ts, sdd/bootstrap/* |
| **LSP** | pi-coding-agent/src/core/lsp/* |
| **Mac Tools** | src/resources/extensions/mac-tools/* |
| **MCP Server/Client** | src/mcp-server.ts, src/resources/extensions/mcp-client/index.ts, vscode-extension/src/sdd-client.ts, modes/rpc/* |
| **Memory Extension** | pi-coding-agent/src/resources/extensions/memory/* |
| **Migration** | sdd/migrate/*, src/pi-migration.ts, pi-coding-agent/src/migrations.ts, scripts/recover-*.sh |
| **Modes** | pi-coding-agent/src/modes/* |
| **Model System** | pi-coding-agent/src/core/model-*.ts, pi-ai/src/models*.ts, pi-ai/src/api-registry.ts, sdd/model-router.ts |
...
| **Skills** | src/resources/skills/*, sdd/skill-telemetry.ts, sdd/preferences-skills.ts, core/skills.ts |
| **Slash Commands** | src/resources/extensions/slash-commands/* |
| **State Machine** | sdd/state.ts, sdd/history.ts, sdd/json-persistence.ts, sdd/memory-store.ts, sdd/reactive-graph.ts, core/agent-session.ts, web/lib/sdd-workspace-store.tsx |
| **Studio App** | studio/* |
...
| **Worktree** | src/worktree-cli.ts, src/worktree-name-gen.ts, sdd/worktree*.ts, tests/repro-worktree-bug/* |
