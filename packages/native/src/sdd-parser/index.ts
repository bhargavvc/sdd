/**
 * SDD file parser — native Rust implementation.
 *
 * Parses `.sdd/` directory markdown files containing YAML-like frontmatter
 ...
 */
export function batchParseSddFiles(
  directory: string,
): BatchParseResult {
  return (native as Record<string, Function>).batchParseSddFiles(
    directory,
  ) as BatchParseResult;
}
