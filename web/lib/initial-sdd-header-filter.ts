export type InitialSddHeaderFilterResult =
...
/**
 * Strip the decorative SDD startup banner from the beginning of a PTY stream.
 *
 ...
 */
export function filterInitialSddHeader(raw: string): InitialSddHeaderFilterResult {
