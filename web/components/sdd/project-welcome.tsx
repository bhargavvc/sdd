...
import type { ProjectDetection } from "@/lib/sdd-workspace-store"
  ...
  switch (detection.kind) {
    case "brownfield":
      return {
        ...
        body: "SDD will map your codebase and ask a few questions about what you want to build. From there it generates structured milestones and deliverable slices.",
    ...
    case "v1-legacy":
      return {
        ...
        headline: "SDD v1 project found",
        body: "This project has a .planning/ folder from an earlier SDD version. Migration converts your existing planning data into the new .sdd/ format.",
    ...
    case "blank":
      return {
        ...
        body: "This folder is empty. SDD will ask what you want to build, then generate a structured plan — milestones broken into deliverable slices with risk-ordered execution.",
        primaryLabel: "Start Project Setup",
        primaryCommand: "/sdd",
      }

    // active-sdd and empty-sdd shouldn't reach here, but handle gracefully
    default:
      return {
        icon: <Folder className="h-8 w-8 text-foreground" strokeWidth={1.5} />,
        headline: "Set up your project",
        body: "Run the SDD wizard to get started.",
      ...
      <div className="w-full max-w-lg">
        ...
        {detection.kind === "brownfield" && (
          <div className="mt-8 rounded-lg border border-border/50 bg-card/50 p-4">
            ...
            <ul className="mt-2.5 space-y-2">
              {[
                "SDD scans your codebase and asks about your goals",
