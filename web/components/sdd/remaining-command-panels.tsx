...
export function QuickPanel() {
  return (
    <div className="space-y-4" data-testid="sdd-surface-sdd-quick">
      <PanelHeader
        title="Quick Task"
          ...
          <div className="space-y-1.5">
            {[
              ...
              <div key={example} className="flex items-center gap-2 text-[11px]">
                ...
                <code className="font-mono text-muted-foreground">/sdd quick {example}</code>
              </div>
            ))}
          </div>
        </div>
...
export function HistoryPanel() {
  ...
  const { loadHistoryData } = useSDDWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="sdd-surface-sdd-history">
      <PanelHeader
...
export function UndoPanel() {
  const workspace = useSDDWorkspaceState()
  const { loadUndoInfo, executeUndoAction } = useSDDWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="sdd-surface-sdd-undo">
      <PanelHeader
...
export function SteerPanel() {
  const workspace = useSDDWorkspaceState()
  const { loadSteerData, sendSteer } = useSDDWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="sdd-surface-sdd-steer">
      <PanelHeader
        title="Steer"
...
export function HooksPanel() {
  const workspace = useSDDWorkspaceState()
  const { loadHooksData } = useSDDWorkspaceActions()
  const state = workspace.commandSurface.remainingCommands.hooks
  const data = state.data as HooksData | null
  const busy = state.phase === "loading"

  return (
    <div className="space-y-4" data-testid="sdd-surface-sdd-hooks">
      <PanelHeader
        title="Hooks"
...
// ═══════════════════════════════════════════════════════════════════════
// 6. INSPECT PANEL — SDD database overview
// ═══════════════════════════════════════════════════════════════════════

export function InspectPanel() {
  const workspace = useSDDWorkspaceState()
  const { loadInspectData } = useSDDWorkspaceActions()
  const state = workspace.commandSurface.remainingCommands.inspect
  const data = state.data as InspectData | null
  const busy = state.phase === "loading"

  return (
    <div className="space-y-4" data-testid="sdd-surface-sdd-inspect">
      <PanelHeader
...
export function ExportPanel() {
  const workspace = useSDDWorkspaceState()
  const { loadExportData } = useSDDWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="sdd-surface-sdd-export">
      <PanelHeader
        title="Export"
...
export function CleanupPanel() {
  const workspace = useSDDWorkspaceState()
  const { loadCleanupData, executeCleanupAction } = useSDDWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="sdd-surface-sdd-cleanup">
      <PanelHeader
        title="Cleanup"
...
export function QueuePanel() {
  ...
  return (
    <div className="space-y-4" data-testid="sdd-surface-sdd-queue">
      <PanelHeader
        title="Queue"
...
export function StatusPanel() {
  ...
  return (
    <div className="space-y-4" data-testid="sdd-surface-sdd-status">
      <PanelHeader
        title="Status"
      ...
      {milestones.length === 0 && (
        <PanelEmpty message="No plan loaded — run /sdd to initialize" />
      )}
    </div>
  )
}
