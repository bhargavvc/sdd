...
const MODE_OPTIONS: {
...
}[] = [
  {
    ...
    description:
      "Dashboard metrics, dual-pane power mode, and direct /sdd command access. Built for people who want visibility into every milestone and task.",
  },
  {
    id: "vibe-coder",
    label: "Vibe Coder",
    ...
    tagline: "Just chat",
    description:
      "Conversational interface with the AI agent. Describe what you want and let SDD handle the structure. Same engine, friendlier surface.",
  },
]
