...
const KIND_STYLE: Record<ProjectDetectionKind, { label: string; color: string; icon: typeof Layers }> = {
  "active-sdd": { label: "Active", color: "text-success", icon: Layers },
  "empty-sdd": { label: "Initialized", color: "text-info", icon: FolderOpen },
...
export function StepProject({ onFinish, onBack, onBeforeSwitch }: StepProjectProps) {
  ...
  const sortedProjects = [...projects].sort((a, b) => {
    const kindOrder: Record<ProjectDetectionKind, number> = { "active-sdd": 0, "empty-sdd": 1, brownfield: 2, "v1-legacy": 3, blank: 4 }
              ...
              return (
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    project.kind === "active-sdd" ? "bg-success/10" : "bg-foreground/[0.04]",
                  )}>
                    {isSwitching ? (
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {/* Row 3: progress info (for active-sdd projects) */}
                    {progress && (
                    ...
                    {/* Row 4: milestone bar (for active-sdd with milestones) */}
