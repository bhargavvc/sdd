...
import { getLiveWorkspaceIndex, useGSDWorkspaceState, type RiskLevel } from "@/lib/sdd-workspace-store"
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        {workspace.bootStatus === "ready" && milestones.length === 0 && (
          <div className="py-8 text-center text-sm text-muted-foreground">
            No milestones found. Create a milestone with <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs">/sdd</code> to get started.
          </div>
        )}
