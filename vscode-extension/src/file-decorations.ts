...
/**
 * Badges files in the VS Code explorer that SDD has written or edited
 * during the current session.
 */
export class SddFileDecorationProvider implements vscode.FileDecorationProvider, vscode.Disposable {
