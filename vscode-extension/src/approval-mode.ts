...
export const SDD_APPROVAL_CONFIG_SECTION = "sdd";
export const SDD_APPROVAL_CONFIG_KEY = "approvalMode";
export const SDD_APPROVAL_CONFIG_PATH = `${SDD_APPROVAL_CONFIG_SECTION}.${SDD_APPROVAL_CONFIG_KEY}`;
