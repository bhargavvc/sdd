// Project/App: SDD-2
// File Purpose: VS Code sidebar webview provider for SDD agent controls and status.
			...
			switch (msg.command) {
				...
				case "toggleFollowUpMode":
					...
					case "selectApprovalMode":
						...
						break;
					default:
						vscode.window.showWarningMessage(`Unknown SDD sidebar command: ${msg.command}`);
						break;
				}
			});
